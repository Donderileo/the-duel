...
export const AI_CHARACTERS: AICharacter[] = [
  {
    ...
    targetWeights: { head: 70, left_shoulder: 10, right_shoulder: 10, left_chest: 5, right_chest: 5 },
  ...
  },
  {
    ...
    targetWeights: { head: 50, left_shoulder: 20, right_shoulder: 20, left_chest: 5, right_chest: 5 },
  ...
  },
  {
    ...
    targetWeights: { head: 20, left_shoulder: 20, right_shoulder: 20, left_chest: 20, right_chest: 20 },
  ...
  },
  {
    ...
    targetWeights: { head: 10, left_shoulder: 30, right_shoulder: 30, left_chest: 15, right_chest: 15 },
  ...
  },
  {
    ...
    targetWeights: { head: 30, left_shoulder: 25, right_shoulder: 25, left_chest: 10, right_chest: 10 },
  ...
  },
  {
    ...
    targetWeights: { head: 60, left_shoulder: 15, right_shoulder: 15, left_chest: 5, right_chest: 5 },
  ...
  },
  {
    ...
    targetWeights: { head: 25, left_shoulder: 20, right_shoulder: 20, left_chest: 20, right_chest: 15 },
